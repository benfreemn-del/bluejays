  ...
  async rewrites() {
    return {
      ...
      beforeFiles: [
        ...
        {
          has: [{ type: 'host', value: 'olympicinspect.com' }],
          source: '/:slug(ermi-testing-olympic-peninsula|inspections-clallam-county|inspections-jefferson-county|inspections-kitsap-county|mold-inspection-bainbridge-island|mold-inspection-bremerton|mold-inspection-chimacum|mold-inspection-forks|mold-inspection-kelso|mold-inspection-longview|mold-inspection-port-angeles|mold-inspection-port-hadlock|mold-inspection-port-ludlow|mold-inspection-port-orchard|mold-inspection-port-townsend|mold-inspection-poulsbo|mold-inspection-quilcene|mold-inspection-sequim-wa|mold-inspection-silverdale|mold-inspection-vancouver-wa|well-water-testing-bremerton|well-water-testing-port-angeles|well-water-testing-port-townsend|well-water-testing-poulsbo|well-water-testing-sequim|well-water-testing-silverdale)',
