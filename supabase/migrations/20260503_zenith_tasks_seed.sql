...
begin
  ...
  ('zenith-sports',
   'Goal 1: client_leads table + wire Zenith forms to write into it',
  ...
  ('zenith-sports',
   'Goal 1: per-client lead dashboard at /dashboard/clients/zenith-sports/leads',
  ...
  ('zenith-sports',
   'Goal 2: per-audience funnel definitions (Parents / Coaches / Players)',
  ...
  ('zenith-sports',
   'Goal 2: write email + SMS content for all 3 funnels',
  ...
  ('zenith-sports',
   'Goal 2: reply detection — pause funnel when lead replies',
  ...
  ('zenith-sports',
   'Goal 3: wire Twilio number once Philip provisions one',
  ...
  ('zenith-sports',
   'Goal 3: build Camp Finder lead magnet',
  ...
  ('zenith-sports',
   'Goal 3: write the Training Guide PDF (coach lead magnet)',
  ...
  ('zenith-sports',
   'Goal 4: Meta ad iterations for each audience (Parents / Coaches / Players)',
  ...
  ('zenith-sports',
   'Goal 4: Google Ads setup + auto-affiliate targeting',
  ...
  ('zenith-sports',
   'Goal 4: weekly performance report (email + dashboard)',
