...
const BASE_URL = (process.env.NEXT_PUBLIC_BASE_URL || "https://bluejayportfolio.com").split("?")[0].replace(/\/$/, "");
...
Best,
BlueJays Team
${EMAIL_FOOTER.replace("{{baseUrl}}", BASE_URL).replace("{{prospectId}}", prospect.id)}`,
    },
