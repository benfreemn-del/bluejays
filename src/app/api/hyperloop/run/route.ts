...
async function runHyperloop(req?: NextRequest) {
  ...
  await supabase.from("hyperloop_runs").insert({
    ...
    rolled_out_count: totalRolledOut,
    rollout_failed_count: totalRolloutFailed,
    paused_on_platform_count: losersPausedOnPlatform,
    pause_failed_count: losersPauseFailed,
