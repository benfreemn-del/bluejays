...
const sections = [
  ...
  },
  {
    ...
    content: [
      ...
      "Opt-in: SMS consent is OPTIONAL and is NOT a condition of submitting our get-started form, receiving a website preview, or purchasing any product or service. You provide express written consent to receive SMS messages from BlueJays at the phone number you submit ONLY when you affirmatively tick the SMS consent checkbox on the public web form at https://bluejayportfolio.com/get-started, OR when you affirmatively tick the SMS consent checkbox on the post-submit opt-in page at https://bluejayportfolio.com/opt-in-sms/[your-id], OR when you reply 'YES' to a one-time confirmation SMS, OR when you provide explicit written or recorded verbal consent through another documented channel. The form can be submitted and the website preview delivered without ticking the SMS box; SMS consent is collected separately from form submission.",
