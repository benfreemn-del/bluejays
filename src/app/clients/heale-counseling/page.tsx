        ...
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          <a href="#top" className="flex items-center gap-2.5">
            <div
              ...
              style={{ background: `linear-gradient(135deg, ${TEAL} 0%, ${TEAL_DEEP} 100%)`, color: "white" }}
            >
              H
            </div>
            <div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <motion.div variants={fadeUp} className="mb-8">
            <Card className="p-7 md:p-9 grid md:grid-cols-[180px_1fr] gap-7 items-center" style={{ borderColor: TEAL_DEEP, borderWidth: 2, background: PANEL }}>
              <div
                className="w-32 h-32 md:w-40 md:h-40 rounded-full mx-auto flex items-center justify-center text-5xl md:text-6xl font-black"
                style={{ background: `linear-gradient(135deg, ${TEAL} 0%, ${TEAL_DEEP} 100%)`, color: "white" }}
              >
                {team[0].initial}
              </div>
