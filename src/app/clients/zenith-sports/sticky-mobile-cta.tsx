...
export default function StickyMobileCta({
  ...
  return (
    ...
    >
      <a
        href={href}
        className="pointer-events-auto flex items-center justify-between gap-3 bg-[#22D3EE] text-[#0a1832] px-5 py-4 rounded-full shadow-[0_8px_24px_rgba(0,0,0,0.35)] hover:bg-white transition active:scale-[0.98]"
      >
