 ...
 * referrers, camp directors. Uses Zenith's TURQ/charcoal/sky palette.
 *
...
export default function ZenithPartnersPage() {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white">
      <header className="border-b border-cyan-500/10">
        <div className="mx-auto max-w-4xl px-6 py-5 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <PartnerApplyForm
              trigger="Apply →"
              className="text-sm font-semibold rounded-md bg-cyan-400 hover:bg-cyan-300 text-slate-950 px-3 py-1.5 transition-colors"
            />
          </div>
        </div>
      </header>
      ...
      {/* Hero */}
      <section className="border-b border-cyan-500/10 bg-gradient-to-b from-cyan-950/40 via-cyan-950/10 to-transparent">
        <div className="mx-auto max-w-3xl px-6 py-16 text-center">
          ...
          <h1 className="text-4xl md:text-6xl font-black leading-tight mb-5">
            ...
            <span className="text-cyan-300">parents trust you. Get paid for it.</span>
          </h1>
          ...
          <div className="inline-flex items-center gap-2 rounded-full border border-cyan-500/40 bg-cyan-500/10 px-4 py-2 mb-7 text-sm text-cyan-200">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
            <PartnerApplyForm
              ...
              className="inline-flex items-center justify-center rounded-md bg-cyan-400 hover:bg-cyan-300 text-slate-950 px-8 py-4 text-base font-bold shadow-lg transition-colors"
            />
            <Link
              href="/clients/zenith-sports/partners/script"
              className="inline-flex items-center justify-center rounded-md border border-cyan-500/30 hover:border-cyan-500/60 bg-slate-900/50 hover:bg-slate-800 px-6 py-4 text-sm text-cyan-200 hover:text-white transition-colors"
            >
      ...
      <section className="border-b border-cyan-500/10">
        <div className="mx-auto max-w-4xl px-6 py-14">
          ...
          <div className="text-center mt-10">
            <Link
              href="/clients/zenith-sports/partners/script"
              className="inline-flex items-center justify-center rounded-md bg-cyan-400 hover:bg-cyan-300 text-slate-950 px-6 py-3 text-sm font-bold transition-colors"
            >
      ...
      <section
        id="how-it-pays"
        className="border-b border-cyan-500/10 scroll-mt-20 bg-slate-900/40"
      >
      ...
      {/* FAQ */}
      <section className="border-b border-cyan-500/10 bg-slate-900/40">
        <div className="mx-auto max-w-3xl px-6 py-14">
...
function PerkCard({
  ...
  return (
    <div className="rounded-xl border border-white/10 bg-slate-950/40 p-5 hover:border-cyan-500/30 transition-colors">
...
function AudienceCard({
  ...
  return (
    <div className="rounded-xl border border-cyan-500/15 bg-gradient-to-b from-cyan-950/15 to-transparent p-5 hover:border-cyan-500/40 transition-colors">
      <div className="flex items-start gap-3">
        <span className="text-2xl shrink-0 leading-none mt-0.5">{emoji}</span>
        <div className="min-w-0">
