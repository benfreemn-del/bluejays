    ...
    >
      ...
      {step !== "results" && (
        <div className="mx-auto max-w-6xl px-5 sm:px-8 mt-4">
          ...
          <div
            className="mt-3 rounded-xl border border-cyan-300/20 px-4 py-2.5 flex items-center gap-3"
            style={{
              background:
                "linear-gradient(90deg, rgba(34, 211, 238,0.08) 0%, rgba(29,78,216,0.04) 100%)",
            }}
          >
            ...
            <p className="text-[12px] sm:text-[13px] leading-snug text-white/80">
              <strong className="font-black" style={{ color: TURQ }}>
                3M+ U.S. kids
              </strong>{" "}
        ...
        {step !== "results" && (
          <div className="mt-10 flex items-center justify-between">
            ...
            <button
              ...
              style={{
                background: canAdvance ? TURQ : "#334155",
      ...
      >
        <p className="text-[11px] tracking-normal">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="underline underline-offset-2 hover:text-[#22D3EE] transition"
          >
            BlueJays
          </a>{" "}
...
function AgeStep({
  ...
  return (
    <div>
      <p className="text-[11px] tracking-[0.32em] uppercase font-bold mb-3" style={{ color: TURQ }}>
        Question 1 of 7
      </p>
          ...
          return (
            <button
              ...
              className={`relative text-left rounded-xl p-4 border-2 transition-all ${
                active
                  ? "bg-cyan-300 border-cyan-300 text-slate-950 hover:scale-[1.02]"
                  : atCap
                    ? "bg-white/[0.02] border-white/5 opacity-40 cursor-not-allowed"
                    : "bg-white/5 border-white/10 hover:border-cyan-300/40 hover:scale-[1.02]"
              }`}
            >
              {active && (
                <span className="absolute top-2 right-2 w-5 h-5 rounded-full bg-slate-950 text-cyan-300 text-xs font-black flex items-center justify-center">
                  ✓
                </span>
              )}
      ...
      <div className="rounded-2xl border border-white/10 bg-black/30 p-3 sm:p-4 mb-5">
        ...
        {stateCode && (
          <p className="text-center text-xs text-white/60 mt-3">
            <span className="font-bold" style={{ color: TURQ }}>
    ...
    <div>
      ...
      <div
        ...
        style={{
          borderColor: `${TURQ}40`,
          background:
            "linear-gradient(135deg, rgba(34, 211, 238,0.08) 0%, rgba(29,78,216,0.05) 100%)",
        }}
      >
      ...
      <div className="relative pt-6 pb-3">
        ...
        >
          {/* Filled progress (TURQ gradient) */}
          <div
            className="absolute inset-y-0 left-0 transition-all duration-200"
            style={{
              width: `${pct}%`,
              background:
                "linear-gradient(90deg, rgba(34, 211, 238,0.55) 0%, rgba(34, 211, 238,0.85) 100%)",
            }}
          />
          {/* Dashed lane stripes */}
          <div
...
function AvailabilityRail({
  ...
  const barColor =
    pct > 25 ? TURQ : pct > 5 ? "#fbbf24" : ELECTRIC;
    ...
    <li className="flex items-center justify-between gap-2">
      ...
      <span
        className={`tabular-nums truncate ml-2 ${
          on ? "text-cyan-300" : "text-white/30"
        }`}
        style={{ maxWidth: 130 }}
      >
        {on ? (value || "—") : "—"}
      ...
      <div className="space-y-3">
        <div>
          ...
          <input
            ...
            className="w-full rounded-xl bg-white/5 border-2 border-white/10 px-4 py-3 text-base text-white placeholder:text-white/30 focus:outline-none focus:border-cyan-300/60"
          />
        </div>
        ...
        <label className="flex items-start gap-3 mt-5 cursor-pointer p-4 rounded-xl bg-cyan-300/10 border-2 border-cyan-300/30">
          <input
            type="checkbox"
            checked={state.notifyOptIn}
            onChange={(e) => update("notifyOptIn", e.target.checked)}
            className="mt-0.5 w-5 h-5 accent-cyan-400 cursor-pointer"
          />
  ...
  return (
    <div>
      ...
      {hasMatches ? (
        ...
        <div className="rounded-2xl border-2 border-cyan-300/30 bg-cyan-300/5 p-6 max-w-md mx-auto text-center">
          <p className="text-base font-bold mb-2" style={{ color: TURQ }}>
            What happens next
          </p>
          ...
          <Link
            ...
            style={{ background: TURQ, color: NAVY_DEEP }}
          >
      ...
      <div className="mt-12 pt-8 border-t border-white/10 text-center">
        ...
        <div className="flex flex-wrap justify-center gap-3">
          ...
          <Link
            ...
            className="text-sm font-bold px-5 py-2.5 rounded-full border border-white/20 hover:bg-white/10"
            style={{ borderColor: TURQ, color: TURQ }}
          >
            ⚽ Shop TEKKY ball
          </Link>
        </div>
  ...
  return (
    ...
    >
      <div className="flex items-start justify-between gap-2 mb-2">
        ...
        {camp.ballIncluded && (
          <span className="text-[9px] uppercase tracking-wider font-black px-1.5 py-0.5 rounded shrink-0" style={{ background: TURQ, color: NAVY_DEEP }}>
            ⚽ ball
          </span>
        )}
      </div>
