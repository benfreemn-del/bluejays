 ...
 * cyan-green energy pop + warm-amber CTA highlights. Sharp corners,
...
// product without overhauling the existing TURQ/electric system.
...
function PromoMarquee() {
  ...
  return (
    <div
      ...
      style={{ background: NAVY_DEEP, color: TURQ }}
    >
    ...
    >
      ...
      >
        ...
        */}
        ...
        <div className="absolute -left-32 top-1/3 w-[480px] h-[2px] bg-[#22D3EE]/30 rotate-[-22deg] hidden md:block" />
        ...
        <div className="relative mx-auto max-w-7xl px-5 sm:px-8 pt-20 sm:pt-28 lg:pt-36 pb-24 sm:pb-32 lg:pb-44 min-h-[88vh] flex flex-col justify-end">
          <div className="max-w-4xl">
            ...
            >
              ...
              <br />
              <span style={{ color: TURQ }}>One touch at a time.</span>
            </h1>
            ...
            <div className="mt-10 flex flex-wrap gap-4 items-center">
              <a
                ...
                className="inline-flex items-center gap-2 bg-[#22D3EE] text-[#0a1832] px-7 py-4 text-[13px] font-extrabold tracking-[0.2em] uppercase hover:bg-white transition group"
              >
              ...
              <a
                ...
                className="text-[12px] font-bold tracking-[0.18em] uppercase text-white/70 hover:text-[#22D3EE] transition underline underline-offset-4"
              >
                Shop socks + tees →
              </a>
            ...
            <div className="mt-4 text-[12px] tracking-[0.18em] uppercase font-bold text-white/65">
              <CTAExperiment
                ...
                className="inline-block hover:text-white underline decoration-[#22D3EE]/40 underline-offset-4 hover:decoration-[#22D3EE] transition"
              />
            </div>
          </div>
        ...
        <div className="mx-auto max-w-7xl px-5 sm:px-8">
          <div className="max-w-3xl">
            ...
            <h2 className="mt-6 text-5xl md:text-7xl font-black uppercase tracking-tighter text-white leading-[0.92]">
              Built for the
              <br />
              <span style={{ color: TURQ }}>technical player.</span>
            </h2>
            <p
          ...
          <div className="mt-16 sm:mt-20 grid md:grid-cols-3 gap-6 lg:gap-10">
            {[
              ...
              return (
                <article
                  key={p.no}
                  className="group relative bg-white/[0.04] border border-white/10 hover:border-[#22D3EE]/40 transition flex flex-col"
                >
                  <div className="relative aspect-[4/3] overflow-hidden">
                    ...
                    >
                      <span className="inline-flex items-center justify-center w-10 h-10 bg-[#22D3EE] text-[#0a1832]">
      ...
      >
        {/* Diagonal accent */}
        <div className="absolute top-1/2 right-0 w-[60%] h-px bg-[#22D3EE]/20" />
        ...
        <div className="mx-auto max-w-7xl px-5 sm:px-8">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <h2 className="mt-6 text-5xl md:text-7xl font-black uppercase tracking-tighter leading-[0.92] text-white">
              ...
              <br />
              to <span style={{ color: TURQ }}>advanced.</span>
            </h2>
            <p
              className="mt-8 text-base md:text-lg leading-relaxed"
              style={{ color: "rgba(255,255,255,0.7)" }}
          ...
          <div className="mt-20 grid md:grid-cols-2 gap-6 lg:gap-10">
            ...
            {/* AFTER */}
            <article className="relative border-2 overflow-hidden" style={{ borderColor: TURQ, background: NAVY_DEEP }}>
              <div className="relative aspect-[4/3] overflow-hidden">
                <img
                  src={PHOTOS.after}
                ...
                <div className="absolute top-6 left-6 inline-flex items-center gap-2 px-4 py-2" style={{ background: TURQ, color: NAVY_INK }}>
              ...
              <div className="p-8 lg:p-10">
                ...
                <ul className="mt-6 space-y-3 text-base text-white/80">
                  <li className="flex items-start gap-3">
                    <CheckCircle size={18} weight="fill" className="mt-1 flex-shrink-0" style={{ color: TURQ }} />
            ...
            <div className="lg:col-span-5 relative">
              <div className="relative aspect-[4/5] overflow-hidden bg-slate-100">
                ...
                <div className="absolute bottom-6 left-6 right-6 text-white">
                  <div className="text-[10px] tracking-[0.28em] uppercase font-extrabold text-[#22D3EE]">
                    The European way
                  </div>
            ...
            <div className="lg:col-span-5 grid sm:grid-cols-2 lg:grid-cols-1 gap-4">
              {[
                ...
                return (
                  ...
                  >
                    <span className="inline-flex flex-shrink-0 items-center justify-center w-11 h-11 bg-[#22D3EE] text-[#0a1832]">
                      <Icon size={20} weight="bold" />
                    </span>
                    <div>
                      <div className="text-[11px] tracking-[0.22em] uppercase font-extrabold text-[#22D3EE]">
                        Why it works
                      </div>
      ...
      >
        ...
        <div className="relative mx-auto max-w-7xl px-5 sm:px-8">
          <div className="grid lg:grid-cols-12 gap-10 lg:gap-16 items-center">
            <div className="lg:col-span-7">
              <Eyebrow color={TURQ}>For coaches, clubs &amp; DOCs</Eyebrow>
              <h2 className="mt-6 text-5xl md:text-7xl font-black uppercase tracking-tighter leading-[0.92] text-white">
                Coach-credible.
                <br />
                <span style={{ color: TURQ }}>Not influencer-first.</span>
              </h2>
              <p
            ...
            <div className="lg:col-span-5">
              ...
              {/* "Zenith Sports promise" testimonial — switched to TEAL
                  to mirror the mint-teal swoosh on the actual ball. TURQ
            ...
            >
              ...
              <div className="p-8 lg:p-10 flex-1 flex flex-col">
                <div className="flex items-center justify-between gap-4">
                  <Eyebrow color={ELECTRIC}>Co-Founder</Eyebrow>
                  <span className="inline-flex items-center gap-1.5 text-[10px] uppercase tracking-[0.2em] font-bold text-[#0a1832] bg-[#22D3EE] px-2.5 py-1">
      ...
      >
        ...
        <div className="relative mx-auto max-w-5xl px-5 sm:px-8 text-center">
          ...
          <h2 className="mt-6 text-5xl md:text-7xl font-black uppercase tracking-tighter leading-[0.92] text-white">
            Transforming
            <br />
            <span style={{ color: TURQ }}>US Soccer.</span>
          </h2>
      ...
      <section className="relative py-16 sm:py-20" style={{ background: NAVY_DEEP }}>
        ...
        <div className="relative mx-auto max-w-6xl px-5 sm:px-8">
          <a
            href="/clients/zenith-sports/build-your-player"
            className="group block rounded-2xl border border-white/10 bg-gradient-to-br from-[#0a1832] via-[#050d1f] to-[#0a1832] hover:border-[#22D3EE]/40 transition-all overflow-hidden"
          >
            <div className="grid lg:grid-cols-[auto_1fr_auto] gap-6 sm:gap-10 items-center p-6 sm:p-10">
              ...
              <div className="min-w-0">
                ...
                >
                  ...
                  <span style={{ color: "#22D3EE" }}>your</span> player.
                </h3>
              ...
              <div className="flex lg:flex-col gap-3 lg:items-end">
                <span
                  className="inline-flex items-center gap-2 px-5 py-3 rounded-md text-[12px] font-extrabold tracking-[0.18em] uppercase whitespace-nowrap shadow-lg group-hover:shadow-[0_0_30px_rgba(34, 211, 238,0.4)] transition-shadow"
                  style={{ background: TURQ, color: NAVY_INK }}
                >
                  Build Your Player
      ...
      <section className="relative overflow-hidden" style={{ background: NAVY }}>
        ...
        <div className="relative mx-auto max-w-5xl px-5 sm:px-8 py-32 sm:py-44 lg:py-56 text-center">
          ...
          <h2 className="mt-6 text-6xl md:text-8xl lg:text-9xl font-black uppercase tracking-tighter leading-[0.88] text-white">
            Get your
            <br />
            <span style={{ color: TURQ }}>TEKKY.</span>
          </h2>
          <p
          ...
          <div className="mt-12 flex flex-wrap items-center justify-center gap-4">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-3 bg-[#22D3EE] text-[#0a1832] px-10 py-5 text-[14px] font-extrabold tracking-[0.22em] uppercase hover:bg-white transition group"
            >
            ...
            <div className="lg:col-span-5">
              ...
              <div className="mt-10 space-y-5">
                ...
                <a
                  ...
                  className="flex items-start gap-4 group"
                >
                  <span className="inline-flex flex-shrink-0 items-center justify-center w-11 h-11 bg-[#22D3EE] text-[#0a1832] group-hover:bg-white transition">
                    <ShoppingCart size={18} weight="bold" />
                  </span>
                  <div>
                    <div className="text-[10px] tracking-[0.22em] uppercase font-bold" style={{ color: INK_SOFT_LIGHT }}>
            ...
            <div className="lg:col-span-5">
              <a href="#top" className="inline-flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-[10px] tracking-[0.28em] uppercase font-semibold" style={{ color: TURQ }}>
                    Home of the TEKKY
                  </div>
                </div>
              </a>
              ...
              >
                ...
                <button
                  type="submit"
                  className="px-5 bg-[#22D3EE] text-[#0a1832] text-[11px] font-extrabold uppercase tracking-[0.2em] hover:bg-white transition"
                >
                  Join
                </button>
              </form>
          ...
          <div className="mt-16 pt-6 border-t border-white/10 flex flex-col md:flex-row gap-4 items-start md:items-center justify-between text-[11px] tracking-[0.18em] uppercase font-semibold text-white/40">
            ...
            <p className="flex items-center gap-2 normal-case tracking-normal text-white/40">
              <a
                ...
                className="text-sky-500/80 hover:text-[#22D3EE] transition"
              >
                <BluejayLogo size={16} />
              </a>
              Built by{" "}
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="hover:text-[#22D3EE] transition underline underline-offset-2"
              >
                BlueJays
              </a>
            </p>
