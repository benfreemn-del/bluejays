...
/**
 * ReviewsCarousel — sliding banner of REAL Google reviews for Hector Landscaping.
 *
...
type Props = {
  reviews: Review[];
  /** Public Google Maps URL — pointed at the Hector Landscaping listing's reviews tab */
  viewAllUrl: string;
};
