...
// Hector Landscaping's actual 10 disciplines, condensed to the 8 most premium-feeling
...
// Each service now has a `photo` for the accordion expansion. Hector Landscaping's
