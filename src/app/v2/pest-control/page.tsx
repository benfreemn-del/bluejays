        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          ...
          <div className="border-t border-white/15 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <p className="text-xs text-gray-500 flex items-center gap-1.5">
              ...
              <a href="https://bluejayportfolio.com/audit" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors" style={{ color: ORANGE_LIGHT }}>BlueJays</a>{" "}— get your free site audit
            </p>
          </div>
        </div>
      </footer>
