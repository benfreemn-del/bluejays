    ...
    <main className="relative min-h-[100dvh] overflow-x-hidden" style={{ background: BG, color: "#f1f5f9" }}>
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-4 md:px-6 w-full grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8">
            ...
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ ...spring, delay: 0.95 }} className="flex flex-wrap gap-3">
              ...
              <span className="px-4 py-2 rounded-full text-xs font-semibold text-white flex items-center gap-2" style={{ background: "rgba(255,255,255,0.05)", border: `1px solid ${ACCENT_LIGHT}40` }}><CheckCircle size={14} weight="duotone" style={{ color: ACCENT_LIGHT }} />Eco-Safe Cleaning</span>
            </motion.div>
        ...
        <div className="mx-auto max-w-4xl px-4 md:px-6">
          <GlassCard className="px-6 py-5 flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-8">
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-slate-400"><span className="text-white font-bold">4.9</span> out of 5 &bull; <span className="text-white font-bold">245</span> reviews</p>
            </div>
          </GlassCard>
        </div>
      </SectionReveal>
      ...
      <SectionReveal className="relative z-10 py-16 md:py-24">
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-4 md:px-6">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl md:text-6xl tracking-tighter leading-none font-bold text-white"><WordReveal text="Per-Surface Pricing" /></h2>
            <p className="text-slate-400 mt-4 max-w-2xl mx-auto">Upfront pricing on our most common services. Exact quote after a free site visit.</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              { name: "Driveway + Walkway", price: "$189", desc: "Most standard 2-car driveways + connecting walkway. Remove years of grime and oil stains.", features: ["Up to 900 sq ft", "Hot-water soft wash + spot treatment", "Concrete-safe detergents", "Oil spot pre-treatment", "Same-day service"], highlight: false },
              { name: "Whole House Soft Wash", price: "$399", desc: "Full exterior soft wash — siding, eaves, soffits, and shutters without damaging paint.", features: ["Up to 2,500 sq ft home", "Low-pressure soft wash", "Algae + mildew treatment", "Includes window rinse", "Protects landscaping"], highlight: true },
              { name: "Deck Restoration", price: "$4.50/sqft", desc: "Deep clean and brighten wood decks, composite decks, and fences. Prep for re-staining.", features: ["Cleaned + brightened", "Mildew + graying treated", "Composite-safe chemicals", "Ready for stain in 48 hrs", "Warranty on prep work"], highlight: false },
            ].map((tier, i) => (
              <div key={i} className={`relative rounded-2xl ${tier.highlight ? 'p-[2px]' : ''}`} style={tier.highlight ? { background: `linear-gradient(135deg, ${ACCENT}, ${ACCENT_LIGHT})` } : {}}>
                ...
                <GlassCard className="p-6 h-full">
                  ...
                  <button className="mt-6 w-full px-6 py-3 rounded-full text-sm font-semibold text-white" style={{ background: tier.highlight ? ACCENT : "rgba(255,255,255,0.05)", border: tier.highlight ? "none" : "1px solid rgba(255,255,255,0.1)" }}>Get Quote</button>
                </GlassCard>
              </div>
            ))}
          </div>
          <p className="text-center text-xs text-slate-500 mt-8">Bundle discounts: save 15% when bundling driveway + walkway + whole-house in one visit.</p>
        </div>
      </SectionReveal>
        ...
        <div className="mx-auto max-w-7xl px-4 md:px-6">
          <GlassCard className="p-6 md:p-8 flex flex-col md:flex-row items-center gap-6">
            ...
            <div className="flex-1 text-center md:text-left">
              <p className="text-xs uppercase tracking-widest mb-1" style={{ color: ACCENT_LIGHT }}>Eco-Friendly Cleaning</p>
              <h3 className="text-2xl md:text-3xl font-bold text-white">Safe For Plants, Pets, &amp; Kids</h3>
              <p className="text-sm text-slate-400 mt-2">Biodegradable, EPA-registered detergents. We cover landscaping, flush runoff into storm-safe capture bags, and use reclaim systems on commercial jobs.</p>
            </div>
            <MagneticButton className="px-8 py-4 rounded-full text-base font-semibold text-white flex items-center gap-2 shrink-0 cursor-pointer" style={{ background: ACCENT } as React.CSSProperties}>
              <CheckCircle size={18} weight="duotone" /> Ask About Green Clean
            </MagneticButton>
          </GlassCard>
        </div>
      </SectionReveal>
      ...
      <SectionReveal className="relative z-10 py-16 md:py-24">
        <div className="mx-auto max-w-6xl px-4 md:px-6">
          <div className="text-center mb-12">
            <p className="text-sm uppercase tracking-widest mb-3" style={{ color: ACCENT }}>See The Transformation</p>
          ...
          <div className="relative rounded-2xl overflow-hidden aspect-video group cursor-pointer">
            ...
            <div className="absolute bottom-6 left-6 right-6">
              <p className="text-xs uppercase tracking-widest" style={{ color: ACCENT_LIGHT }}>Driveway Timelapse &bull; 2:18</p>
              <p className="text-xl md:text-2xl font-bold text-white mt-1">Grimy to gleaming — a full driveway + walkway in under 90 minutes.</p>
            </div>
          </div>
        </div>
      </SectionReveal>
      ...
      <SectionReveal className="relative z-10 py-16 md:py-24">
        <div className="relative z-10 mx-auto max-w-5xl px-4 md:px-6">
          <div className="text-center mb-12">
            <p className="text-sm uppercase tracking-widest mb-3" style={{ color: ACCENT }}>What Needs Cleaning?</p>
            <h2 className="text-4xl md:text-5xl tracking-tighter leading-none font-bold text-white"><WordReveal text="Pick Your Surface" /></h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {[
              { color: "#22c55e", label: "Concrete", detail: "Driveways, walkways, patios, garage floors — hard surfaces that take high pressure.", rec: "Hot-Water Surface Cleaner", icon: CheckCircle },
              { color: ACCENT, label: "Siding / House", detail: "Vinyl, fiber cement, brick, stucco — softwash to protect without damage.", rec: "Whole House Soft Wash", icon: ShieldCheck },
              { color: ACCENT_LIGHT, label: "Wood / Deck", detail: "Decks, fences, pergolas — gentle clean + brighten to prep for stain.", rec: "Deck Restoration", icon: Star },
            ].map((opt, i) => (
      ...
      <SectionReveal className="relative z-10 py-16 md:py-24">
        <div className="mx-auto max-w-5xl px-4 md:px-6">
          <div className="text-center mb-12">
            ...
            <h2 className="text-4xl md:text-5xl tracking-tighter leading-none font-bold text-white"><WordReveal text="Us vs. Renting a Unit" /></h2>
          </div>
          <GlassCard className="overflow-hidden">
            <div className="grid grid-cols-[1.5fr_1fr_1fr] items-center border-b border-white/15">
              ...
              <div className="p-4 md:p-6 text-center" style={{ background: `${ACCENT}15` }}>
                <p className="text-sm md:text-base font-bold" style={{ color: ACCENT_LIGHT }}>Us</p>
              </div>
              <div className="p-4 md:p-6 text-center">
                <p className="text-sm md:text-base font-semibold text-slate-400">DIY / Big Box Rental</p>
              </div>
            </div>
            {[
              { feature: "Commercial 4000 PSI hot-water rigs", us: "Standard", them: "2000 PSI cold" },
              { feature: "Soft-wash + detergent system", us: "Yes", them: "Water only" },
              { feature: "EPA-registered eco detergents", us: "Included", them: "Separate purchase" },
              { feature: "Surface damage insurance", us: "$1M policy", them: "You own the risk" },
              { feature: "Licensed + insured techs", us: "Always", them: "No" },
              { feature: "Most 2-story soft washes", us: "1–2 hours", them: "A full weekend" },
              { feature: "Satisfaction guarantee", us: "Re-clean free", them: "No recourse" },
            ].map((row, i) => (
      ...
      <SectionReveal className="relative z-10 py-8">
        <div className="mx-auto max-w-6xl px-4 md:px-6">
          <p className="text-center text-xs uppercase tracking-widest text-slate-500 mb-6">Credentials &amp; Standards</p>
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-3">
            {[
              { label: "UAMCC Member", icon: ShieldCheck },
              { label: "PWNA Certified", icon: Star },
              { label: "BBB A+", icon: CheckCircle },
              { label: "EPA SmartWash", icon: ShieldCheck },
              { label: "$1M Liability", icon: ShieldCheck },
              { label: "Satisfaction Promise", icon: CheckCircle },
            ].map((cert, i) => (
        ...
        <div className="mx-auto max-w-7xl px-4 md:px-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <GlassCard className="p-6 text-center">
              ...
              <p className="text-xs uppercase tracking-widest mb-2" style={{ color: ACCENT_LIGHT }}>Coverage</p>
              <p className="text-3xl font-black text-white">40 Miles</p>
              <p className="text-sm text-slate-400 mt-2">Metro, suburbs, and commercial accounts throughout the region. Route-based scheduling minimizes your wait.</p>
            </GlassCard>
            <GlassCard className="p-6 text-center">
              <div className="w-14 h-14 rounded-full flex items-center justify-center mx-auto mb-4" style={{ background: ACCENT_GLOW }}>
                <Clock size={26} weight="duotone" style={{ color: ACCENT_LIGHT }} />
              </div>
              <p className="text-xs uppercase tracking-widest mb-2" style={{ color: ACCENT_LIGHT }}>Project Time</p>
              <p className="text-3xl font-black text-white">1–4 Hrs</p>
              <p className="text-sm text-slate-400 mt-2">Most residential jobs complete in a single 1–4 hour visit. Larger commercial projects scheduled over multiple days.</p>
            </GlassCard>
            <GlassCard className="p-6 text-center">
              ...
              <p className="text-xs uppercase tracking-widest mb-2" style={{ color: ACCENT_LIGHT }}>Scheduling</p>
              <p className="text-3xl font-black text-white">Within 7 Days</p>
              <p className="text-sm text-slate-400 mt-2">Most homes scheduled within a week of quoting. Peak spring season books out faster — reserve early.</p>
            </GlassCard>
          </div>
        </div>
      </SectionReveal>
