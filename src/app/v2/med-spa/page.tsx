...
const testimonials = [
  { name: "Priya M.", text: "Dr. Patel is a true artist. After my Juvederm treatment, I look like myself but 10 years younger. The results are so natural that my friends just think I look well-rested.", rating: 5, treatment: "Juvederm" },
  ...
  { name: "Anika T.", text: "After years of struggling with acne scarring, the microneedling sessions with Dr. Patel have completely transformed my skin. My confidence is through the roof.", rating: 5, treatment: "Microneedling" },
...
const faqData = [
  { q: "Is Botox safe? What are the side effects?", a: "Botox is FDA-approved and has an excellent safety profile when administered by qualified providers. Minor bruising or swelling may occur but resolves within days. Dr. Patel has performed thousands of injections with a stellar safety record." },
  { q: "How do I know which treatment is right for me?", a: "Every new client receives a complimentary skin analysis and consultation with Dr. Patel. We assess your skin health, discuss your goals, and create a personalized treatment plan tailored to your unique needs and timeline." },
  ...
  { q: "What makes Radiance Med Spa different?", a: "Dr. Patel is a board-certified dermatologist with 16 years of experience and a Yale Medical School education. We combine clinical expertise with a luxury spa environment, using only premium medical-grade products and the latest technology." },
];
      ...
      <div className="relative min-h-screen w-full overflow-hidden flex items-center justify-center">
        ...
        <div className="relative z-10 flex flex-col items-center justify-center text-center px-4 pt-24 pb-16">
          ...
          <p className="text-lg md:text-xl text-slate-400 max-w-2xl mb-8">
            <WordReveal text="Board-certified dermatologist Dr. Anya Patel combines 16 years of medical expertise with luxury aesthetics for results you can see and feel." className="gap-x-2" />
          </p>
        ...
        <div className="mx-auto max-w-7xl px-4 md:px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <motion.div className="aspect-[3/4] rounded-2xl overflow-hidden relative" initial={{ opacity: 0, scale: 0.95 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }} transition={spring}>
              <img src="https://images.unsplash.com/photo-1614608682850-e0d6ed316d47?w=800&q=80" alt="Dr. Anya Patel, MD" className="w-full h-full object-cover object-top" />
            ...
            <div>
              ...
              <h2 className="text-4xl md:text-5xl tracking-tighter leading-none font-bold text-white mb-2" style={{ fontFamily: "'Georgia', serif" }}>
                <WordReveal text="Dr. Anya Patel, MD" />
              </h2>
              ...
              <p className="text-slate-400 leading-relaxed mb-4">
                Dr. Anya Patel founded Radiance Med Spa in Seattle with a singular vision: to merge the precision of medical science with the artistry of aesthetic beauty. A graduate of Yale Medical School with 16 years of clinical dermatology experience, Dr. Patel brings a level of expertise that sets Radiance apart from every other med spa in the Pacific Northwest.
              </p>
              ...
              <MagneticButton className="px-8 py-3 rounded-full text-base font-semibold text-white inline-flex items-center gap-2 cursor-pointer" style={{ background: BLUSH } as React.CSSProperties}>
                Book with Dr. Patel <ArrowRight size={18} />
              </MagneticButton>
            </div>
          </div>
        </div>
      ...
      <SectionReveal className="relative z-10 py-16 md:py-24" style={{ background: `linear-gradient(180deg, transparent 0%, ${BG_CARD} 15%, ${BG_CARD} 85%, transparent 100%)` } as React.CSSProperties}>
        <div className="mx-auto max-w-7xl px-4 md:px-6">
          ...
          <motion.div className="grid grid-cols-1 md:grid-cols-4 gap-8 text-center" variants={stagger} initial="hidden" whileInView="show" viewport={{ once: true, margin: "-50px" }}>
            {[
              { title: "Consultation", desc: "Complimentary skin analysis with Dr. Patel to understand your goals and craft a personalized plan.", icon: Handshake },
            ...
            <div>
              ...
              <motion.div className="grid grid-cols-1 sm:grid-cols-2 gap-4" variants={stagger} initial="hidden" whileInView="show" viewport={{ once: true, margin: "-50px" }}>
                {[
                  ...
                  { icon: ShieldCheck, title: "Medical Supervision", desc: "Every treatment overseen by Dr. Patel, a board-certified dermatologist." },
          ...
          <ShimmerBorder>
            <div className="p-8 md:p-12 text-center">
              <motion.div initial={{ opacity: 0, scale: 0.9 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }} transition={spring}>
                ...
                <p className="text-slate-400 text-lg mb-8 max-w-lg mx-auto">Schedule your complimentary consultation with Dr. Patel and discover a personalized plan designed just for you.</p>
