        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="border-t border-white/[0.10] pt-6 flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <div className="text-xs text-white/25 flex items-center gap-1.5">
              ...
              <a href="https://bluejayportfolio.com" target="_blank" rel="noopener noreferrer" className="hover:text-white/50 transition-colors underline">BlueJays</a>{" "}— get your free site audit
            </div>
          </div>
        </div>
      </footer>
