          ...
          <div className="max-w-2xl space-y-5 md:space-y-8">
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ ...spring, delay: 0.8 }} className="flex flex-wrap gap-4">
              ...
              <MagneticButton className="px-8 py-4 rounded-full text-base font-semibold text-white border border-white/15 flex items-center gap-2 cursor-pointer">
                <Phone size={18} weight="duotone" /> (425) 629-4150
              </MagneticButton>
            </motion.div>
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ ...spring, delay: 1 }} className="flex flex-wrap gap-3">
              ...
              <span className="px-4 py-2 rounded-full text-xs font-semibold text-white flex items-center gap-2" style={{ background: "rgba(255,255,255,0.05)", border: `1px solid ${WOOD}50` }}><ShieldCheck size={14} weight="duotone" style={{ color: WOOD_LIGHT }} />WA L&amp;I #FENCECO529DR</span>
      ...
      <SectionReveal id="testimonials" className="relative z-10 py-16 md:py-24">
        <div className="mx-auto max-w-7xl px-4 md:px-6">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl md:text-6xl tracking-tighter leading-none font-bold text-white">
              <WordReveal text="Neighbors Trust Us" />
            </h2>
          </div>
      ...
      <SectionReveal className="relative z-10 py-16 md:py-24">
        <div className="mx-auto max-w-6xl px-4 md:px-6">
          ...
          <div className="relative rounded-2xl overflow-hidden aspect-video group cursor-pointer">
            <img src="https://images.unsplash.com/photo-1748908271592-d9d5690b288b?w=1600&q=80" alt="Fencing crew installation" className="w-full h-full object-cover object-top transition-transform duration-700 group-hover:scale-105" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              ...
              <GlassCard key={i} className="p-5">
                ...
                <p className="mt-4 pt-4 border-t border-white/8 text-xs text-slate-300">Best for: <span className="font-semibold text-white">{mat.best}</span></p>
              </GlassCard>
            ))}
          </div>
        </div>
      ...
      <SectionReveal className="relative z-10 py-16 md:py-24">
        <div className="mx-auto max-w-5xl px-4 md:px-6">
          <GlassCard className="p-8 md:p-12 text-center">
            ...
            <p className="mt-6 text-xs text-slate-500">WA L&amp;I #FENCECO529DR &bull; Bonded &bull; Fully Insured &bull; 20+ Years</p>
