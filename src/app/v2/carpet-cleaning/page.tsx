      ...
      <footer className="max-w-6xl mx-auto px-4 py-12 border-t border-white/15">
        ...
        <div className="mt-10 pt-6 border-t border-white/8 text-center text-slate-500 text-xs">
          ...
          <p className="mt-1 flex items-center gap-1.5">
            ...
            <a href="https://bluejayportfolio.com" target="_blank" rel="noopener noreferrer" className="text-slate-400 hover:text-cyan-400 transition-colors">BlueJays</a>{" "}— get your free site audit
          </p>
        </div>
      </footer>
