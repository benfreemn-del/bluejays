          ...
          <ShimmerBorder>
            <div className="p-8 md:p-12 text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <MagneticButton className="px-8 py-4 rounded-full text-lg font-semibold text-slate-300 border border-white/15 bg-white/5" onClick={() => window.location.href = "tel:2065550483"}>
      ...
      <footer className="max-w-6xl mx-auto px-4 py-12 border-t border-white/15">
        ...
        <div className="mt-10 pt-6 border-t border-white/8 text-center text-slate-500 text-xs">
          ...
          <p className="mt-1 flex items-center gap-1.5">
            ...
            <a href="https://bluejayportfolio.com/audit" target="_blank" rel="noopener noreferrer" className="text-slate-400 hover:text-cyan-400 transition-colors">BlueJays</a>{" "}— get your free site audit
          </p>
        </div>
      </footer>
