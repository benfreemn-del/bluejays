      ...
      <footer className="relative z-10 border-t border-gray-100 py-12">
        <div className="mx-auto max-w-7xl px-4 md:px-6">
          ...
          <div className="border-t border-gray-100 pt-6 flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <p className="text-xs text-[#6b7280]">Created by <a href="https://bluejayportfolio.com" target="_blank" rel="noopener noreferrer" className="underline hover:text-[#1c1917] transition-colors">bluejayportfolio.com</a></p>
          </div>
        </div>
      </footer>
    </main>
