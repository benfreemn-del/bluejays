...
const sermons = [
  ...
  { title: "Love Your Neighbor", speaker: "Pastor Rachel Kim", date: "Mar 30, 2026", series: "Better Together", img: "https://images.unsplash.com/photo-1445445290350-18a3b86e0b5a?w=600&q=80" },
              ...
              <div className="p-8 md:p-12 flex flex-col justify-center">
                ...
                <div className="space-y-4 text-base leading-relaxed" style={{ color: BODY }}>
                  <p>
                    ...
                    lives and moved to Seattle with a wild idea: plant a church that felt like
                    family.
                  </p>
                  <p>
                    David preaches with warmth and humor. Rachel leads worship and the
                    women&apos;s ministry. Together, they set the tone for everything Grace is:
                    honest, joyful, and unapologetically welcoming.
                  </p>
                </div>
        ...
        <div className="mx-auto max-w-7xl px-4 md:px-6">
          ...
          <div className="border-t pt-8 flex flex-col md:flex-row items-center justify-between gap-4" style={{ borderColor: CARD_BORDER }}>
            ...
            <p className="text-xs flex items-center gap-1.5" style={{ color: BODY }}>
              ...
              <a href="https://bluejayportfolio.com/audit" target="_blank" rel="noopener noreferrer" className="font-medium hover:underline" style={{ color: AMBER }}>BlueJays</a>{" "}— get your free site audit
            </p>
          </div>
        </div>
      </footer>
