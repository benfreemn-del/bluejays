        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="pt-8 border-t border-white/15 flex flex-col md:flex-row items-center justify-between gap-4 text-xs text-slate-500">
            ...
            <p className="flex items-center gap-1.5">
              ...
              <a href="https://bluejayportfolio.com" target="_blank" rel="noopener noreferrer" className="underline hover:text-teal-400 transition-colors">BlueJays</a>{" "}— get your free site audit
            </p>
          </div>
        </div>
      </footer>
