        ...
        <div className="max-w-7xl mx-auto px-4 md:px-6">
          ...
          <div className="mt-12 pt-8 border-t border-white/8 flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <p className="text-xs text-slate-600 flex items-center gap-1.5">
              ...
              <a href="https://bluejayportfolio.com" target="_blank" rel="noopener noreferrer" className="underline hover:text-slate-400 transition-colors">BlueJays</a>{" "}— get your free site audit
            </p>
          </div>
        </div>
      </footer>
