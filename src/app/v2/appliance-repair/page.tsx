        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="pt-8 border-t border-white/8 flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <p className="text-xs flex items-center gap-1.5" style={{ color: STEEL }}>
              ...
              <a href="https://bluejayportfolio.com/audit" target="_blank" rel="noopener noreferrer" className="underline hover:text-white transition-colors" style={{ color: STEEL_LIGHT }}>BlueJays</a>{" "}— get your free site audit
            </p>
          </div>
        </div>
      </footer>
