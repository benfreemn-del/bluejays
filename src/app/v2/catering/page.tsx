    ...
    <div className="pointer-events-none fixed inset-0 z-0 overflow-hidden hidden md:block">
      {particles.map((p) => (
        <motion.div key={p.id} className="absolute rounded-full"
          style={{ left: `${p.x}%`, width: p.size, height: p.size, background: p.isGold ? GOLD : BURGUNDY, willChange: "transform, opacity" }}
...
function ShimmerBorder({ children, className = "" }: { children: React.ReactNode; className?: string }) {
  return (
    <div className={`relative rounded-2xl p-[1px] overflow-hidden ${className}`}>
      ...
      <div className="relative rounded-2xl bg-[#0f0a0a] z-10">{children}</div>
    </div>
  );
}
  ...
  return (
    <main className="relative min-h-[100dvh] overflow-x-hidden" style={{ background: BG, color: "#f1f5f9" }}>
        ...
        <div className="mx-auto max-w-7xl px-4 md:px-6 py-4">
          <GlassCard className="flex items-center justify-between px-4 md:px-6 py-3">
            <div className="flex items-center gap-2">
              ...
              <span className="text-lg font-bold tracking-tight" style={{ color: CREAM }}>Ember &amp; Oak Catering</span>
            </div>
            ...
            <div className="flex items-center gap-3">
              <MagneticButton className="px-4 md:px-5 py-2 rounded-full text-sm font-semibold text-white transition-colors cursor-pointer" style={{ background: BURGUNDY }}>
                Book Event
              </MagneticButton>
      ...
      <section className="relative min-h-[100dvh] flex items-center pt-24 z-10 overflow-hidden">
        <div className="absolute inset-0" style={{ background: `linear-gradient(135deg, #1a0a0a 0%, ${BG} 50%, #150d0d 100%)` }} />
        <ElegantPattern opacity={0.04} />
        <VineDecor />
        <div className="absolute top-1/4 left-1/4 w-[600px] h-[600px] rounded-full blur-[200px] pointer-events-none" style={{ background: `${BURGUNDY}10` }} />
        <div className="absolute bottom-1/4 right-1/4 w-[400px] h-[400px] rounded-full blur-[160px] pointer-events-none" style={{ background: `${GOLD}08` }} />
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-4 md:px-6 w-full grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-8 items-center">
          <div className="space-y-8">
            <div>
              ...
              <h1 className="text-4xl md:text-6xl tracking-tighter leading-none font-bold" style={{ color: CREAM, textShadow: "0 2px 10px rgba(0,0,0,0.5)" }}>
            ...
            <div className="flex flex-wrap gap-4">
              <MagneticButton className="px-8 py-4 rounded-full text-base font-semibold text-white flex items-center gap-2 cursor-pointer" style={{ background: BURGUNDY }}>
      ...
      <SectionReveal className="relative z-10 py-16 overflow-hidden border-y border-white/10">
        <div className="absolute inset-0" style={{ background: `linear-gradient(180deg, #120a0a 0%, ${BG} 100%)` }} />
      ...
      <SectionReveal id="services" className="relative z-10 py-24 md:py-32 overflow-hidden">
        <div className="absolute inset-0" style={{ background: `linear-gradient(180deg, ${BG} 0%, #120a0a 50%, ${BG} 100%)` }} />
        <ElegantPattern />
        ...
        <div className="max-w-6xl mx-auto px-6 relative z-10">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-5xl font-extrabold tracking-tight text-white">Catering for Every Occasion</h2>
      ...
      <SectionReveal id="gallery" className="relative z-10 py-24 md:py-32 overflow-hidden">
        <div className="absolute inset-0" style={{ background: `linear-gradient(180deg, ${BG} 0%, #10080a 50%, ${BG} 100%)` }} />
        ...
        <div className="max-w-6xl mx-auto px-6 relative z-10">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-5xl font-extrabold tracking-tight text-white">A Feast for the Eyes</h2>
            <div className="h-0.5 w-16 mx-auto mt-4" style={{ background: `linear-gradient(to right, ${BURGUNDY}, transparent)` }} />
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <div className="relative">
              ...
              <div className="absolute -bottom-4 -right-4 md:bottom-6 md:-right-6">
                <div className="px-5 py-3 rounded-xl backdrop-blur-md border text-white font-bold text-sm shadow-lg" style={{ background: `${BURGUNDY}e6`, borderColor: `${BURGUNDY}80` }}>15+ Years of Excellence</div>
              </div>
            </div>
            <div>
              ...
              <h2 className="text-3xl md:text-5xl font-extrabold tracking-tight mb-6 text-white">Crafted with Passion</h2>
      ...
      <SectionReveal className="relative z-10 py-24 md:py-32 overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-6 relative z-10">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-5xl font-extrabold tracking-tight text-white">From Vision to Table</h2>
            <div className="h-0.5 w-16 mx-auto mt-4" style={{ background: `linear-gradient(to right, ${BURGUNDY}, transparent)` }} />
          </div>
      ...
      <SectionReveal className="relative z-10 py-24 md:py-32 overflow-hidden">
        ...
        <div className="max-w-3xl mx-auto px-6 relative z-10">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-5xl font-extrabold tracking-tight text-white">Questions &amp; Answers</h2>
            <div className="h-0.5 w-16 mx-auto mt-4" style={{ background: `linear-gradient(to right, ${BURGUNDY}, transparent)` }} />
          </div>
      ...
      <section className="relative z-10 py-20 overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-6 relative z-10 text-center">
          ...
          <a href="tel:+12065550298" className="inline-flex items-center gap-3 px-8 py-4 rounded-full bg-white text-black font-bold text-lg hover:bg-white/90 transition-colors">
        ...
        <div className="max-w-6xl mx-auto px-6 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            <div>
              ...
              <h2 className="text-3xl md:text-5xl font-extrabold tracking-tight mb-6 text-white">Plan Your Event</h2>
              <p className="text-slate-400 leading-relaxed mb-8">Ready to create an unforgettable culinary experience? Contact us to schedule your complimentary consultation.</p>
            ...
            <GlassCard className="p-8">
              <h3 className="text-xl font-semibold text-white mb-6">Request a Consultation</h3>
              <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
                ...
                <div><label className="block text-sm text-slate-400 mb-1.5">Event Type</label>
                ...
                <div><label className="block text-sm text-slate-400 mb-1.5">Event Details</label><textarea rows={4} className="w-full px-4 py-3 rounded-xl bg-white/5 border border-white/10 text-white placeholder-slate-500 focus:outline-none text-sm resize-none" placeholder="Tell us about your event — date, guest count, dietary needs..." /></div>
                <MagneticButton className="w-full py-4 rounded-xl text-base font-semibold text-white flex items-center justify-center gap-2 cursor-pointer" style={{ background: BURGUNDY }}>
      ...
      <footer className="relative z-10 border-t border-white/5 py-10 overflow-hidden">
        <div className="absolute inset-0" style={{ background: `linear-gradient(180deg, ${BG} 0%, #080505 100%)` }} />
        <ElegantPattern opacity={0.015} />
        <div className="mx-auto max-w-6xl px-6 relative z-10">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
            <div>
              <div className="flex items-center gap-2 mb-3"><ForkKnife size={22} weight="fill" style={{ color: BURGUNDY }} /><span className="text-lg font-bold" style={{ color: CREAM }}>Ember &amp; Oak Catering</span></div>
              <p className="text-sm text-slate-500 leading-relaxed">Award-winning catering for weddings, corporate events, and private dining.</p>
            </div>
            <div>
              <h4 className="text-sm font-semibold text-white mb-3">Quick Links</h4>
              <div className="space-y-2">
                {["Services", "Gallery", "About", "Contact"].map((link) => <a key={link} href={`#${link.toLowerCase()}`} className="block text-sm text-slate-500 hover:text-white transition-colors">{link}</a>)}
              </div>
            </div>
            <div>
          ...
          <div className="border-t border-white/5 pt-6 flex flex-col md:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-2 text-sm text-slate-500"><ForkKnife size={14} weight="fill" style={{ color: BURGUNDY }} /><span>Ember &amp; Oak Catering &copy; {new Date().getFullYear()}</span></div>
