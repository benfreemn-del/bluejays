...
const FAQS = [
  ...
  },
  {
    ...
    a: "The $10k AI System is product-makers + indie authors only. Service businesses (electricians, landscapers, dental, salons, HVAC, contractors) we still build websites for at the $997 tier — that ladder's open. But we don't take service-trade businesses ON THE AI SYSTEM TIER. Why: the $10k math justifies itself when there's a defined product, a tight-fit audience you can retarget across years, and a story the AI can learn. A service that's the same as ten others on the block has no compounding customer relationship to teach the system — ad spend burns fast and the system can't pay itself back. If you make a product only you make, or you write a fiction series readers want to follow book-to-book, this is the right fit at $10k. If you're a service business and want a great website without the AI System tier, the $997 site path is still wide open — start at /audit.",
  },
  {
