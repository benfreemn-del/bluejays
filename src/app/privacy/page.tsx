...
const sections = [
  ...
  },
  {
    ...
    content: [
      "BlueJays may send promotional emails to business owners and representatives regarding our services, including offers to view a free custom website preview. We send promotional SMS text messages ONLY to recipients who have provided express written consent through one of our documented opt-in channels — namely, by ticking the optional SMS consent checkbox on the get-started form at https://bluejayportfolio.com/get-started, by ticking the optional SMS consent checkbox on the post-submit opt-in page at https://bluejayportfolio.com/opt-in-sms/[your-id], or by providing explicit written or recorded verbal consent through another documented channel. SMS consent is OPTIONAL — it is NOT a condition of submitting any form, receiving a website preview, or purchasing any product or service.",
