...
const THEME_LIBRARY: Record<string, { url: string; name: string }[]> = {
  ...
  cleaning: [
    ...
    { url: "https://images.unsplash.com/photo-1563453392212-326f5e854473?w=800&q=80", name: "window-clean" },
  ],
  landscaping: [
  ...
  "carpet-cleaning": [
    ...
    { url: "https://images.unsplash.com/photo-1594824476967-48c8b964273f?w=800&q=80", name: "pro-equipment" },
  ...
  church: [
    ...
    { url: "https://images.unsplash.com/photo-1545128485-c400e7702796?w=800&q=80", name: "church-lobby" },
  ],
  daycare: [
  ...
  "med-spa": [
    ...
    { url: "https://images.unsplash.com/photo-1655455561178-0d3c092d0edb?w=800&q=80", name: "injectable-treatment" },
  ...
  fencing: [
    ...
    { url: "https://images.unsplash.com/photo-1636750403333-4e5a627f5411?w=800&q=80", name: "fence-installation" },
    ...
    { url: "https://images.unsplash.com/photo-1759901599396-ef760e4f00d6?w=800&q=80", name: "privacy-fence" },
  ...
  "garage-door": [
    ...
    { url: "https://images.unsplash.com/photo-1665901227196-a8dd2b650676?w=800&q=80", name: "insulated-door" },
  ...
  locksmith: [
    ...
    { url: "https://images.unsplash.com/photo-1600083907313-9a511348d11f?w=800&q=80", name: "locksmith-tools" },
  ...
  "pressure-washing": [
    { url: "https://images.unsplash.com/photo-1592365559101-19adfefdf294?w=800&q=80", name: "pressure-washer-action" },
    ...
    { url: "https://images.unsplash.com/photo-1645256418914-feb28d7ec701?w=800&q=80", name: "siding-wash" },
    ...
    { url: "https://images.unsplash.com/photo-1711098256664-d2ea62e6e376?w=800&q=80", name: "before-after-surface" },
  ...
  towing: [
    ...
    { url: "https://images.unsplash.com/photo-1690790751457-bccf964c1f4c?w=800&q=80", name: "car-being-towed" },
    { url: "https://images.unsplash.com/photo-1616728827388-84563c099b29?w=800&q=80", name: "jump-start" },
  ...
  "tree-service": [
    ...
    { url: "https://images.unsplash.com/photo-1675478769911-3e0555b613f7?w=800&q=80", name: "fallen-tree" },
  ...
  "appliance-repair": [
    ...
    { url: "https://images.unsplash.com/photo-1585515320310-259814833e62?w=800&q=80", name: "technician-working" },
    { url: "https://images.unsplash.com/photo-1594938298603-c8148c4dae35?w=800&q=80", name: "tools" },
    { url: "https://images.unsplash.com/photo-1626806819282-2c1dc01a5e0c?w=800&q=80", name: "dryer-repair" },
    { url: "https://images.unsplash.com/photo-1556909211-36987daf7b4d?w=800&q=80", name: "appliance-parts" },
