...
const FAQS = [
  ...
  },
  {
    ...
    a: "The $10k AI System is the main goal for indie authors with a series — three ways to pay: (1) $9,700 up front and save $300. (2) $3,500 to start, $3,500 at day 30, $3,000 at day 60 — $10,000 total. (3) $2,500 today and $2,500 every 90 days, four times — $10,000 total, then it stops on its own. Same $10k whether you take 1 path or another — pick whichever fits your cash flow. After the build, ongoing runs at $500-1,000/mo (newsletter platform + Claude + ad spend if you run any — those bills go to the vendors, not to us). If only book #1 is live and book #2 is 12+ months out, the $997 author website tier is the right starting point — see the 'only one book' question above.",
  },
];
