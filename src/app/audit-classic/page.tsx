 ...
 * /audit-classic/[id]/processing while the AI generates.
 *
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://bluejayportfolio.com/audit-classic",
    type: "website",
  },
};
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white">
        ...
        dangerouslySetInnerHTML={{
          __html: jsonLdString(
            breadcrumbLd([
              ...
              { name: "Free Audit", url: "https://bluejayportfolio.com/audit-classic" },
            ]),
          ),
        }}
      />
      ...
      {/* Real client testimonials — render the shared <AuditTestimonials/>
          ...
          of truth for both /audit and /audit-classic/[id]. */}
      <AuditTestimonials />
