...
/**
 * /audit-classic/[id] — Hormozi salty-pretzel report display.
 *
    ...
    return (
      <main className="min-h-screen bg-slate-950 text-white flex items-center justify-center px-6">
        <div className="text-center max-w-lg">
          ...
          <Link
            href={`/audit-classic/${id}/processing`}
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white">
      ...
      {/* Capture ?ref=<code> on the audit-share landing too — partners
          can share /audit-classic/[id] preview links of their referrals. */}
      <PartnerRefCapture />
      ...
      <section className="border-b border-white/5 bg-gradient-to-b from-rose-950/20 to-transparent">
        <div className="mx-auto max-w-4xl px-6 py-14 text-center">
          ...
          <div className="mt-6">
            <ShareAuditButton
              auditUrl={`${SITE_ORIGIN}/audit-classic/${a.id}`}
      ...
      <footer className="border-t border-white/5 pb-24 md:pb-20">
        <div className="mx-auto max-w-4xl px-6 py-8 text-center text-xs text-slate-500 space-y-2">
          ...
          <p>
            ...
            <Link href="/audit-classic" className="text-sky-400 hover:underline ml-2">Audit a different site →</Link>
          </p>
        </div>
      </footer>
