...
const defaultSiteCards: SiteCard[] = [
  ...
  { name: "All In One Services", category: "General contractor", color: "#15110c", href: "/clients/all-in-one-services", icon: "🔨", tagline: "Kitchen + bath + additions · Sequim WA", group: "service" },
