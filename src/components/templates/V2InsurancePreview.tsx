        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 relative z-10">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            {carrierPartners.map((carrier) => (
              <div key={carrier} className="flex items-center gap-2 px-5 py-3 rounded-xl border border-white/[0.13] bg-white/[0.08]">
                <ShieldCheck size={18} weight="fill" style={{ color: ACCENT }} />
          ...
          <ShimmerBorder accent={ACCENT} className="mx-auto">
            <div className="p-8 md:p-12">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                ...
                <PhoneLink phone={data.phone} className="inline-flex items-center gap-3 px-8 py-4 rounded-full border border-white/15 text-white font-semibold hover:bg-white/5 transition-colors">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            ...
            <GlassCard className="p-8">
              ...
              <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
                ...
                <div><label className="block text-sm text-slate-400 mb-1.5">Message</label><textarea rows={4} className="w-full px-4 py-3 rounded-xl bg-white/5 border border-white/15 text-white placeholder-slate-500 focus:outline-none transition-colors text-sm resize-none" placeholder="Tell us about your insurance needs..." /></div>
