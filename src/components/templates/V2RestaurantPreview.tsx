  ...
  return (
    <main className="relative min-h-[100dvh] overflow-x-hidden" style={{ background: CHARCOAL, color: "#f1f5f9" }}>
      ...
      <section id="menu" className="relative z-10 py-24 md:py-32 overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-6 relative z-10">
          <SectionHeader badge="Our Menu" title="Signature Dishes & Specialties" subtitle={`Experience the flavors of ${data.businessName} — crafted with passion and the finest ingredients.`} accent={ACCENT} />
      ...
      <footer className="relative z-10 border-t border-white/5 py-10 overflow-hidden">
        ...
        <div className="mx-auto max-w-6xl px-6 relative z-10">
          ...
          <div className="border-t border-white/5 pt-6 flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-2 text-xs text-slate-600"><span>Created by <a href="https://bluejayportfolio.com" target="_blank" rel="noopener noreferrer" style={{textDecoration:"underline"}}>bluejayportfolio.com</a></span></div>
          </div>
        </div>
      </footer>
