...
function getAccent(accentColor?: string) {
  ...
  return {
    ACCENT: c,
    ACCENT_GLOW: `${c}26`,
    ACCENT_LIGHT: RED_LIGHT,
    GOLD: GOLD_ACCENT,
  };
}

const PALETTE = ["#dc2626", "#d4a053", "#1c1917", "#fef3c7", "#7f1d1d", "#92400e"];
...
/* â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ FLOATING FOOD PARTICLES â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
      ...
      {particles.map((p) => (
        <motion.div
          ...
          style={{
            ...
            width: p.size,
            height: p.size,
            background: p.isGold ? GOLD_ACCENT : accent,
...
/* â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ FOOD/DINING SVG PATTERN â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
function DiningPattern({ opacity = 0.03, accent }: { opacity?: number; accent: string }) {
  const patternId = `diningPatternV2-${accent.replace("#", "")}`;
  return (
    <svg className="absolute inset-0 w-full h-full pointer-events-none" style={{ opacity }}>
      <defs>
        <pattern id={patternId} width="100" height="100" patternUnits="userSpaceOnUse">
          ...
          <circle cx="50" cy="50" r="12" fill="none" stroke={accent} strokeWidth="0.3" />
          <line x1="30" y1="50" x2="20" y2="35" stroke={accent} strokeWidth="0.5" strokeLinecap="round" />
          <line x1="70" y1="50" x2="80" y2="35" stroke={accent} strokeWidth="0.5" strokeLinecap="round" />
          <circle cx="50" cy="50" r="3" fill={accent} opacity="0.3" />
          <line x1="0" y1="0" x2="15" y2="15" stroke={accent} strokeWidth="0.3" opacity="0.2" />
          <line x1="85" y1="85" x2="100" y2="100" stroke={accent} strokeWidth="0.3" opacity="0.2" />
        </pattern>
      </defs>
...
/* â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ FLAME SVG BACKGROUND â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
function FlameBackground({ opacity = 0.03, accent }: { opacity?: number; accent: string }) {
  return (
    <svg className="absolute inset-0 w-full h-full pointer-events-none" style={{ opacity }} viewBox="0 0 1000 600" preserveAspectRatio="none">
      <path d="M150 600 Q160 400 130 300 Q140 200 180 100 Q170 200 200 300 Q190 400 200 600Z" fill={accent} opacity="0.3" />
      <path d="M800 600 Q810 350 780 250 Q790 150 830 50 Q820 150 850 250 Q840 350 850 600Z" fill={GOLD_ACCENT} opacity="0.2" />
      <path d="M500 600 Q490 450 510 350 Q500 250 520 150 Q510 250 530 350 Q520 450 540 600Z" fill={accent} opacity="0.15" />
    </svg>
  );
}

/* â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ HERO BACKGROUND SVG â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
function HeroDecor({ accent }: { accent: string }) {
  return (
    <svg className="absolute inset-0 w-full h-full pointer-events-none" viewBox="0 0 1200 800" preserveAspectRatio="none" style={{ opacity: 0.05 }}>
      <circle cx="200" cy="400" r="150" fill="none" stroke={accent} strokeWidth="1" />
      <circle cx="200" cy="400" r="100" fill="none" stroke={GOLD_ACCENT} strokeWidth="0.5" />
      <circle cx="1000" cy="300" r="120" fill="none" stroke={accent} strokeWidth="0.8" />
      <path d="M400 0 Q500 200 400 400 Q300 600 400 800" fill="none" stroke={GOLD_ACCENT} strokeWidth="0.5" />
      <path d="M800 0 Q700 200 800 400 Q900 600 800 800" fill="none" stroke={accent} strokeWidth="0.5" />
    </svg>
  );
}
  ...
  return (
    <div className={`relative rounded-2xl p-[1px] overflow-hidden ${className}`}>
      <motion.div
        ...
        style={{ background: `conic-gradient(from 0deg, transparent, ${accent}, transparent, ${GOLD_ACCENT}, transparent)`, willChange: "transform" }}
...
export default function V2RestaurantPreview({ data }: { data: GeneratedSiteData }) {
  ...
  const processSteps = [
    { step: "01", title: "Browse Our Menu", desc: "Explore our carefully crafted menu featuring seasonal ingredients and chef specialties." },
    { step: "02", title: "Reserve Your Table", desc: "Book online or call us to reserve the perfect table for your occasion." },
    { step: "03", title: "Savor the Experience", desc: "Enjoy exceptional cuisine, warm hospitality, and an unforgettable atmosphere." },
    { step: "04", title: "Share the Love", desc: "Tell friends and family about your experience. We love hearing your feedback." },
  ];

  const faqs = [
    { q: `What type of cuisine does ${data.businessName} serve?`, a: `We specialize in a variety of dishes including ${data.services.slice(0, 3).map(s => s.name).join(", ")}, and more. Our menu changes seasonally to feature the freshest ingredients.` },
    { q: "Do you accept reservations?", a: "Yes! We highly recommend reservations, especially for weekends and holidays. You can call us or book online through our website." },
    { q: "Do you offer catering or private dining?", a: `Absolutely! ${data.businessName} offers full-service catering and private dining for events of all sizes. Contact us for a custom menu consultation.` },
    { q: "Do you accommodate dietary restrictions?", a: "We are happy to accommodate vegetarian, vegan, gluten-free, and other dietary needs. Please inform your server or mention it when making your reservation." },
  ];

  /* Fallback testimonials */
  const fallbackTestimonials = [
    { name: "Sarah M.", text: "Best dining experience in town. The ambiance and food were absolutely incredible.", rating: 5 },
    { name: "Kevin D.", text: "We come here every Friday night. The menu never disappoints and the service is always top-notch.", rating: 5 },
    { name: "Rachel L.", text: "Hosted our anniversary dinner here and it was perfect. The chef even prepared a special dessert.", rating: 5 }
  ];
  const testimonials = data.testimonials?.length > 0 ? data.testimonials : fallbackTestimonials;

  return (
    <main className="relative min-h-[100dvh] overflow-x-hidden" style={{ fontFamily: "DM Sans, system-ui, sans-serif", background: CHARCOAL, color: "#f1f5f9" }}>
        ...
        <div className="mx-auto max-w-7xl px-4 md:px-6 py-4">
          <GlassCard className="flex items-center justify-between px-4 md:px-6 py-3">
            <div className="flex items-center gap-2">
              <ForkKnife size={24} weight="fill" style={{ color: ACCENT }} />
            ...
            {mobileMenuOpen && (
              <motion.div initial={{ opacity: 0, height: 0 }} animate={{ opacity: 1, height: "auto" }} exit={{ opacity: 0, height: 0 }} transition={{ duration: 0.3, ease: "easeInOut" }} className="md:hidden mt-2 overflow-hidden">
                <GlassCard className="flex flex-col gap-1 px-4 py-4">
                  {[{ label: "Menu", href: "#menu" }, { label: "About", href: "#about" }, { label: "Gallery", href: "#gallery" }, { label: "Contact", href: "#contact" }].map((link) => (
            ...
            <div className="relative rounded-2xl overflow-hidden border border-white/15">
              ...
              <div className="absolute bottom-6 left-6 flex items-center gap-3">
                <div className="px-4 py-2 rounded-full backdrop-blur-md bg-black/50 border flex items-center gap-2" style={{ borderColor: `${ACCENT}4d` }}>
                  <Star size={18} weight="fill" style={{ color: ACCENT }} />
        ...
        <div className="max-w-6xl mx-auto px-6 relative z-10">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {data.stats.map((stat, i) => {
              const statIcons = [Star, ForkKnife, Users, Clock];
      ...
      <section className="relative z-10 py-24 md:py-32 overflow-hidden">
        <div className="absolute inset-0" style={{ background: "linear-gradient(180deg, #1a1a1a 0%, #141010 50%, #1a1a1a 100%)" }} />
        <DiningPattern opacity={0.02} accent={ACCENT} />
        ...
        <div className="max-w-6xl mx-auto px-6 relative z-10">
          <AnimatedSection>          <SectionHeader badge="Reviews" title="What Our Guests Say" accent={ACCENT} /></AnimatedSection>
      ...
      {/* â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â• 5. MENU / SERVICES â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â• */}
      <section id="menu" className="relative z-10 py-24 md:py-32 overflow-hidden">
        <div className="absolute inset-0" style={{ background: "linear-gradient(180deg, #1a1a1a 0%, #141010 50%, #1a1a1a 100%)" }} />
        <DiningPattern accent={ACCENT} />
        <FlameBackground opacity={0.025} accent={ACCENT} />
        <div className="absolute inset-0 pointer-events-none">
          <div className="absolute top-[10%] right-[5%] w-[500px] h-[500px] rounded-full blur-[160px]" style={{ background: `${ACCENT}08` }} />
          <div className="absolute bottom-[10%] left-[5%] w-[400px] h-[400px] rounded-full blur-[140px]" style={{ background: `${GOLD_ACCENT}05` }} />
        </div>
        <div className="max-w-6xl mx-auto px-6 relative z-10">
          <SectionHeader badge="Our Menu" title="Signature Dishes & Specialties" subtitle={`Experience the flavors of ${data.businessName} â€” crafted with passion and the finest ingredients.`} accent={ACCENT} />
      ...
      <section id="about" className="relative z-10 py-24 md:py-32 overflow-hidden">
        <div className="absolute inset-0" style={{ background: "linear-gradient(180deg, #1a1a1a 0%, #0f0c0c 50%, #1a1a1a 100%)" }} />
        <FlameBackground opacity={0.02} accent={ACCENT} />
            ...
            <div className="relative">
              ...
              <div className="absolute -bottom-4 -right-4 md:bottom-6 md:-right-6">
                <div className="px-5 py-3 rounded-xl backdrop-blur-md border text-white font-bold text-sm shadow-lg" style={{ background: `${ACCENT}e6`, borderColor: `${ACCENT}80` }}>
                  {data.stats[0] ? `${data.stats[0].value} ${data.stats[0].label}` : "Since Day One"}
                </div>
              </div>
            </div>
            <div>
              ...
              <h2 className="text-3xl md:text-5xl font-extrabold tracking-tight mb-6 text-white">A Passion for Great Food</h2>
              <p className="text-slate-400 leading-relaxed mb-8">{data.about}</p>
              <div className="grid grid-cols-2 gap-4">
                {[
                  { icon: Fire, label: "Fresh Ingredients" },
      ...
      <section className="relative z-10 py-24 md:py-32 overflow-hidden">
        <div className="absolute inset-0" style={{ background: "linear-gradient(180deg, #1a1a1a 0%, #141010 50%, #1a1a1a 100%)" }} />
        <DiningPattern opacity={0.025} accent={ACCENT} />
        <div className="absolute inset-0 pointer-events-none"><div className="absolute bottom-[20%] right-[10%] w-[500px] h-[500px] rounded-full blur-[180px]" style={{ background: `${GOLD_ACCENT}06` }} /></div>
        <div className="max-w-6xl mx-auto px-6 relative z-10">
          <AnimatedSection>          <SectionHeader badge="Your Experience" title="How It Works" accent={ACCENT} /></AnimatedSection>
      ...
      {/* â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â• 8. GALLERY (GALLERY-HEAVY) â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â• */}
      <section id="gallery" className="relative z-10 py-24 md:py-32 overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-6 relative z-10">
          <SectionHeader badge="Gallery" title="A Feast for the Eyes" subtitle="Explore our dishes, ambiance, and dining experiences." accent={ACCENT} />
              ...
              return (
                <div key={i} className="group relative rounded-2xl overflow-hidden border border-white/[0.10] hover:border-opacity-30 transition-all duration-500 aspect-square">
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-4 opacity-0 group-hover:opacity-100 transition-opacity duration-500">
                    <h3 className="text-sm font-bold text-white">{captions[i] || `Dish ${i + 1}`}</h3>
                  </div>
                </div>
              );
            })}
      ...
      {/* â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â• 9. RESERVATION CTA â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â• */}
      <section className="relative z-10 py-20 overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-6 relative z-10 text-center">
          <ForkKnife size={48} weight="fill" className="mx-auto mb-6 text-white/70" />
          <h2 className="text-3xl md:text-5xl font-black tracking-tight text-white mb-4">Ready for an Unforgettable Meal?</h2>
          <p className="text-lg text-white/80 mb-8 max-w-xl mx-auto">Reserve your table today and experience the finest flavors our kitchen has to offer.</p>
      ...
      <section className="relative z-10 py-24 md:py-32 overflow-hidden">
        <div className="absolute inset-0" style={{ background: "linear-gradient(180deg, #1a1a1a 0%, #0f0c0c 50%, #1a1a1a 100%)" }} />
        <DiningPattern opacity={0.02} accent={ACCENT} />
        <div className="absolute inset-0 pointer-events-none"><div className="absolute top-[40%] right-[20%] w-[400px] h-[400px] rounded-full blur-[180px]" style={{ background: `${GOLD_ACCENT}06` }} /></div>
        <div className="max-w-6xl mx-auto px-6 relative z-10">
          <AnimatedSection>          <SectionHeader badge="Location" title="Find Us" accent={ACCENT} /></AnimatedSection>
          <div className="text-center">
            <GlassCard className="p-8 inline-block">
              ...
              <p className="text-slate-400 text-sm mt-2">Dine-In &bull; Takeout &bull; Catering</p>
            </GlassCard>
          </div>
        </div>
      </section>
      ...
      {data.hours && (
        <section className="relative z-10 py-24 md:py-32 overflow-hidden">
          ...
          <div className="max-w-3xl mx-auto px-6 relative z-10">
            <AnimatedSection>          <SectionHeader badge="Hours" title="When We're Open" accent={ACCENT} /></AnimatedSection>
            <div className="text-center">
              <ShimmerBorder accent={ACCENT}>
                <div className="p-8">
                  ...
                  <p className="text-sm mt-4 font-semibold" style={{ color: ACCENT }}>Reservations Recommended</p>
                </div>
              </ShimmerBorder>
            </div>
          </div>
        ...
        <div className="max-w-6xl mx-auto px-6 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            <div>
              ...
              <h2 className="text-3xl md:text-5xl font-extrabold tracking-tight mb-6 text-white">Make a Reservation</h2>
              <p className="text-slate-400 leading-relaxed mb-8">Ready to dine with us? Contact {data.businessName} to book your table, plan a private event, or inquire about catering.</p>
              <div className="space-y-5">
                ...
                <div className="flex items-start gap-4">
                  <div className="w-10 h-10 rounded-xl flex items-center justify-center shrink-0" style={{ background: ACCENT_GLOW }}><ForkKnife size={20} weight="duotone" style={{ color: ACCENT }} /></div>
                  <div><p className="text-sm font-semibold text-white">Dining Options</p><p className="text-sm text-slate-400">Dine-In, Takeout, Catering, Private Events</p></div>
                </div>
                {data.hours && (
                  <div className="flex items-start gap-4">
      ...
      {/* â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â• 14. GUARANTEE / TRUST BANNER â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â• */}
        ...
        <div className="max-w-4xl mx-auto px-6 relative z-10 text-center">
          <ShimmerBorder accent={ACCENT}>
            <div className="p-8 md:p-12">
              ...
              <h2 className="text-2xl md:text-4xl font-extrabold text-white mb-4">Our Promise to You</h2>
              <p className="text-slate-400 leading-relaxed max-w-2xl mx-auto text-lg">
                At {data.businessName}, every dish is prepared with the freshest ingredients, every guest is treated like family, and every visit is an experience worth savoring.
              </p>
              <div className="flex flex-wrap justify-center gap-4 mt-8">
                {["Fresh Ingredients", "Exceptional Service", "Warm Atmosphere", "Locally Sourced"].map((item) => (
      ...
      {/* â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â• CHEF SPOTLIGHT â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â• */}
      <section className="relative z-10 py-20 overflow-hidden">
      ...
      {/* â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â• SEASONAL SPECIALS â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â• */}
      <section className="relative z-10 py-20 overflow-hidden">
      ...
      {/* â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â• RESERVATION & MID-PAGE CTA â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â• */}
      <section className="relative z-10 py-16 overflow-hidden">
      ...
      <section className="relative z-10 py-20 overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-6 relative z-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
            {[
              { title: "Scratch Kitchen", desc: "Every dish prepared fresh from scratch daily â€” no shortcuts, no frozen ingredients" },
      ...
      {/* â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â• HOURS & DINING INFO â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â• */}
      {data.hours && (
      <section className="relative z-10 py-16 overflow-hidden">
        <div className="absolute inset-0" style={{ background: "linear-gradient(180deg, #141010 0%, #1a1a1a 100%)" }} />
        <DiningPattern opacity={0.01} accent={ACCENT} />
      ...
      {/* â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â• ENHANCED CERTIFICATIONS â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â• */}
      <section className="relative z-10 py-16 overflow-hidden">
        <div className="absolute inset-0" style={{ background: "linear-gradient(180deg, #1a1a1a 0%, #141010 100%)" }} />
        <DiningPattern opacity={0.012} accent={ACCENT} />
        <div className="max-w-6xl mx-auto px-6 relative z-10">
      ...
      <footer className="relative z-10 border-t border-white/8 py-10 overflow-hidden">
        ...
        <div className="mx-auto max-w-6xl px-6 relative z-10">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
            <div>
              <div className="flex items-center gap-2 mb-3"><ForkKnife size={22} weight="fill" style={{ color: ACCENT }} /><span className="text-lg font-bold text-white">{data.businessName}</span></div>
            ...
            <div>
              ...
              <div className="space-y-2">{["Menu", "About", "Gallery", "Contact"].map((link) => <a key={link} href={`#${link.toLowerCase()}`} className="block text-sm text-slate-500 hover:text-white transition-colors">{link}</a>)}</div>
            </div>
            <div>
          ...
          <div className="border-t border-white/8 pt-6 flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-2 text-xs text-slate-600"><BluejayLogo className="w-4 h-4" /><span>Built by <a href="https://bluejayportfolio.com" target="_blank" rel="noopener noreferrer" style={{textDecoration:"underline"}}>BlueJays</a> — get your free site audit</span></div>
          </div>
        </div>
      </footer>
