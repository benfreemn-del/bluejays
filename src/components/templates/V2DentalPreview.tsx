...
const STOCK_HERO = "https://images.unsplash.com/photo-1629909613654-28e377c37b09?w=1400&q=80";
const STOCK_ABOUT = "https://images.unsplash.com/photo-1588776814546-1ffcf47267a5?w=600&q=80";
const STOCK_GALLERY = [
  ...
  return (
    ...
    >
      ...
      <section className="relative min-h-[100dvh] flex items-center pt-24 z-10 overflow-hidden">
        <div className="absolute inset-0" style={{ background: "linear-gradient(135deg, #0c1a2e 0%, #0f172a 50%, #0d1f2d 100%)" }} />
        <DentalPattern opacity={0.04} accent={TEAL} />
        <div className="absolute top-1/4 left-1/4 w-[600px] h-[600px] rounded-full blur-[200px] pointer-events-none" style={{ background: `${TEAL}08` }} />
        <div className="absolute bottom-1/4 right-1/4 w-[400px] h-[400px] rounded-full blur-[160px] pointer-events-none" style={{ background: `${TEAL_LIGHT}06` }} />
                  ...
                  <div className="relative z-10">
                    <div className="flex items-start justify-between mb-5">
                      <div
                        ...
                        style={{ background: TEAL_GLOW, borderColor: `${TEAL}33` }}
                      >
