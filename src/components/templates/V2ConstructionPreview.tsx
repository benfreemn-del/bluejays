        ...
        <div className="max-w-6xl mx-auto px-6 relative z-10">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            {MATERIALS.map((material) => (
              <div key={material} className="px-6 py-3 rounded-xl border border-white/10 bg-white/[0.02] text-sm font-semibold text-slate-300 hover:border-white/20 transition-colors">
                {material}
              </div>
            ))}
          </div>
            ...
            <GlassCard className="p-8">
              ...
              <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
                ...
                <div><label className="block text-sm text-slate-400 mb-1.5">Project Details</label>
                  <textarea rows={3} className="w-full px-4 py-3 rounded-xl bg-white/5 border border-white/10 text-white placeholder-slate-500 focus:outline-none text-sm resize-none" placeholder="Describe your construction project..." /></div>
