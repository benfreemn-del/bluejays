...
const STOCK_ABOUT = "https://images.unsplash.com/photo-1519491050282-cf6b6839be98?w=600&q=80";
const STOCK_GALLERY = [
...
function ClaimBanner({ businessName, accentColor, prospectId }: {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50">
      <div className="bg-[#1a1a2e]/90 backdrop-blur-sm border-t border-white/10 px-4 py-2 flex items-center justify-center gap-4">
        <p className="text-xs text-slate-400">
          <span className="inline-block w-2 h-2 rounded-full bg-green-500 mr-1.5 animate-pulse" />
          47 churches in your area upgraded their website this month
        </p>
  ...
  return (
    <main className="relative min-h-[100dvh] overflow-x-hidden" style={{ background: NAVY, color: "#f1f5f9" }}>
      ...
      <section className="relative min-h-[100dvh] flex items-center pt-24 z-10 overflow-hidden">
        <div className="absolute inset-0" style={{ background: `radial-gradient(ellipse 80% 60% at 50% 30%, ${GOLD_GLOW} 0%, transparent 70%), radial-gradient(ellipse 60% 50% at 80% 70%, ${GOLD}08 0%, transparent 60%)` }} />
