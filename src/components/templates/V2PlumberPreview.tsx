...
const STOCK_ABOUT = "https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?w=600&q=80";
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50">
      <div className="bg-[#0f172a]/90 backdrop-blur-sm border-t border-white/10 px-4 py-2 flex items-center justify-center gap-4">
        <p className="text-xs text-slate-400"><span className="inline-block w-2 h-2 rounded-full bg-green-500 mr-1.5 animate-pulse" />47 plumbing businesses in your area upgraded their website this month</p>
  ...
  return (
    <main className="relative min-h-[100dvh] overflow-x-hidden" style={{ background: SLATE, color: "#f1f5f9" }}>
      ...
      <section className="relative min-h-[100dvh] flex items-center pt-24 z-10 overflow-hidden">
        <div className="absolute inset-0" style={{ background: "linear-gradient(135deg, #0c1222 0%, #0f172a 50%, #0c1830 100%)" }} />
      ...
      <section className="relative z-10 py-24 md:py-32 overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-6 relative z-10">
          <SectionHeader badge="Our Process" title="How We Work" accent={TEAL} />
      ...
      <section id="projects" className="relative z-10 py-24 md:py-32 overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-6 relative z-10">
          <SectionHeader badge="Our Work" title="Recent Projects" accent={TEAL} />
      ...
      <section className="relative z-10 py-24 md:py-32 overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-6 relative z-10">
          <SectionHeader badge="Testimonials" title="What Our Clients Say" accent={TEAL} />
      ...
      {data.hours && (
        <section className="relative z-10 py-24 md:py-32 overflow-hidden">
          ...
          <div className="max-w-3xl mx-auto px-6 relative z-10">
            <SectionHeader badge="Business Hours" title="When We're Available" accent={TEAL} />
            <div className="text-center">
