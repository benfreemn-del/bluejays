...
const STOCK_HERO = "https://images.unsplash.com/photo-1587654780291-39c9404d7dd0?w=1400&q=80";
  ...
  return (
    <main className="relative min-h-[100dvh] overflow-x-hidden" style={{ background: CHARCOAL, color: "#f1f5f9" }}>
      ...
      <section className="relative min-h-[100dvh] flex items-center pt-24 z-10 overflow-hidden">
        <div className="absolute inset-0" style={{ background: "linear-gradient(135deg, #1a0f2e 0%, #0f0a1a 50%, #1a1a1a 100%)" }} />
      ...
      <section className="relative z-10 py-16 overflow-hidden border-y" style={{ borderColor: `${ACCENT}1a` }}>
        <div className="absolute inset-0" style={{ background: "linear-gradient(180deg, #0f0a1a 0%, #1a1a1a 100%)" }} />
      ...
      <section id="services" className="relative z-10 py-24 md:py-32 overflow-hidden">
        <div className="absolute inset-0" style={{ background: "linear-gradient(180deg, #1a1a1a 0%, #0f0a1a 50%, #1a1a1a 100%)" }} />
      ...
      <section id="about" className="relative z-10 py-24 md:py-32 overflow-hidden">
        <div className="absolute inset-0" style={{ background: "linear-gradient(180deg, #1a1a1a 0%, #1a0f2e 50%, #1a1a1a 100%)" }} />
        ...
        <div className="max-w-6xl mx-auto px-6 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div>
              ...
              <h2 className="text-3xl md:text-5xl font-extrabold tracking-tight mb-6 text-white">Where Little Stars Shine</h2>
      ...
      <section className="relative z-10 py-20 overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-6 relative z-10 text-center">
          ...
          <h2 className="text-3xl md:text-5xl font-black tracking-tight text-white mb-4">Enroll Your Child Today</h2>
        ...
        <div className="max-w-6xl mx-auto px-6 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            <div>
              ...
              <h2 className="text-3xl md:text-5xl font-extrabold tracking-tight mb-6 text-white">Schedule a Tour</h2>
              <p className="text-slate-400 leading-relaxed mb-8">Looking for quality child care? Contact {data.businessName} today for a free, no-obligation estimate. We respond to all inquiries within 24 hours.</p>
              <div className="space-y-5">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div><p className="text-sm font-semibold text-white">Child Safety</p><p className="text-sm text-slate-400">Safe, nurturing environment for your child</p></div>
                </div>
                {data.hours && (
                  <div className="flex items-start gap-4">
            ...
            <GlassCard className="p-8">
              <h3 className="text-xl font-semibold text-white mb-6">Request a Schedule Tour</h3>
              <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
                ...
                <div><label className="block text-sm text-slate-400 mb-1.5">Message</label><textarea rows={4} className="w-full px-4 py-3 rounded-xl bg-white/5 border border-white/10 text-white placeholder-slate-500 focus:outline-none transition-colors text-sm resize-none" placeholder="Tell us about your child and what program interests you..." /></div>
      ...
      <footer className="relative z-10 border-t border-white/5 py-10 overflow-hidden">
        ...
        <div className="mx-auto max-w-6xl px-6 relative z-10">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
            <div>
              <div className="flex items-center gap-2 mb-3"><Heart size={22} weight="fill" style={{ color: ACCENT }} /><span className="text-lg font-bold text-white">{data.businessName}</span></div>
          ...
          <div className="border-t border-white/5 pt-6 flex flex-col md:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-2 text-sm text-slate-500"><Heart size={14} weight="fill" style={{ color: ACCENT }} /><span>{data.businessName} &copy; {new Date().getFullYear()}</span></div>
