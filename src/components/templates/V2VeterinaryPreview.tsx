...
const STOCK_GALLERY = [
  ...
  "https://images.unsplash.com/photo-1450778869180-cfe0112515ba?w=600&q=80",
  "https://images.unsplash.com/photo-1583337130417-13571a35e157?w=800&q=80",
  ...
  return (
    <main className="relative min-h-[100dvh] overflow-x-hidden" style={{ background: CHARCOAL, color: "#f1f5f9" }}>
      ...
      <section className="relative min-h-[100dvh] flex items-center pt-24 z-10 overflow-hidden">
        <div className="absolute inset-0" style={{ background: "linear-gradient(135deg, #0a150e 0%, #0d120f 50%, #1a1a1a 100%)" }} />
            ...
            <div className="relative rounded-2xl overflow-hidden border border-white/10">
              ...
              <div className="absolute bottom-6 left-6 flex items-center gap-3">
                <div className="px-4 py-2 rounded-full backdrop-blur-md bg-black/50 border flex items-center gap-2" style={{ borderColor: `${PRIMARY}4d` }}>
                  ...
                  <span className="text-sm font-semibold text-white">Your Pet&apos;s Best Friend</span>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="relative z-10 py-16 overflow-hidden border-y" style={{ borderColor: `${PRIMARY}1a` }}>
        <div className="absolute inset-0" style={{ background: "linear-gradient(180deg, #111512 0%, #1a1a1a 100%)" }} />
      ...
      <section id="services" className="relative z-10 py-24 md:py-32 overflow-hidden">
        <div className="absolute inset-0" style={{ background: "linear-gradient(180deg, #1a1a1a 0%, #0d140f 50%, #1a1a1a 100%)" }} />
      ...
      <section id="about" className="relative z-10 py-24 md:py-32 overflow-hidden">
        <div className="absolute inset-0" style={{ background: "linear-gradient(180deg, #1a1a1a 0%, #0b120e 50%, #1a1a1a 100%)" }} />
        ...
        <div className="max-w-6xl mx-auto px-6 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div>
              ...
              <h2 className="text-3xl md:text-5xl font-extrabold tracking-tight mb-6 text-white">Where Pets Are Family</h2>
      ...
      <section className="relative z-10 py-24 md:py-32 overflow-hidden">
        <div className="absolute inset-0" style={{ background: "linear-gradient(180deg, #1a1a1a 0%, #111512 50%, #1a1a1a 100%)" }} />
              ...
              <div className="space-y-5">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-400">Always accepting new furry patients</p>
                  </div>
                </div>
                {data.hours && (
                  <div className="flex items-start gap-4">
              ...
              <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input type="text" className="w-full px-4 py-3 rounded-xl bg-white/5 border border-white/10 text-white placeholder-slate-500 focus:outline-none transition-colors text-sm" placeholder="Jane Smith" />
                  </div>
                  <div>
                    <label className="block text-sm text-slate-400 mb-1.5">Pet&apos;s Name</label>
                    <input type="text" className="w-full px-4 py-3 rounded-xl bg-white/5 border border-white/10 text-white placeholder-slate-500 focus:outline-none transition-colors text-sm" placeholder="Buddy" />
                  </div>
                </div>
                <div>
                ...
                <div>
                  ...
                  <textarea rows={4} className="w-full px-4 py-3 rounded-xl bg-white/5 border border-white/10 text-white placeholder-slate-500 focus:outline-none transition-colors text-sm resize-none" placeholder="Tell us about your pet's needs..." />
                </div>
      ...
      <section className="relative z-10 py-16 overflow-hidden">
        <div className="absolute inset-0" style={{ background: "linear-gradient(180deg, #1a1a1a 0%, #111512 100%)" }} />
        ...
        <div className="max-w-4xl mx-auto px-6 relative z-10 text-center">
          <ShimmerBorder accent={PRIMARY}>
            <div className="p-8 md:p-12">
              ...
              <h2 className="text-2xl md:text-4xl font-extrabold text-white mb-4">Our Promise to You &amp; Your Pet</h2>
