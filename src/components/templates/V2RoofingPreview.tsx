            ...
            {ROOFING_MATERIALS.map((mat, i) => {
              ...
              return (
                <GlassCard key={mat.name} className="p-6 text-center group hover:border-white/20 transition-all duration-300">
                  <div className="w-14 h-14 rounded-2xl mx-auto mb-4 flex items-center justify-center" style={{ background: `${tile}22`, border: `1px solid ${tile}55` }}>
                    <mat.icon size={28} weight="duotone" style={{ color: tile }} />
                  </div>
