...
const PUBLIC_API_PATHS = [
  ...
  "/api/meta/status",                  // Meta Marketing API connection verifier — Bearer-auth in the route. Backs `bj meta status`.
  "/api/meta/launch",                  // Meta launch orchestrator (campaign + ad sets + ads) — Bearer-auth in the route. Backs `bj meta launch`.
  ...
  "/api/clients/kr-ranches/checkout",    // Public online-checkout — mints a Square payment link
  "/api/clients/kr-ranches/square-webhook", // Public Square webhook (HMAC signature-verified)
